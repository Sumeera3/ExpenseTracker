...
import { Carousel, CarouselItem, ModalBody, ModalDialog, ModalFooter, ModalHeader, Offcanvas, OffcanvasBody } from 'react-bootstrap';
...
const Display = ({ data1, Tbalance, design }) => {
    ...
    return (
        <>
            <div className=' w-100 d-flex pt-3 main ' >
                ...
                <div className='d-noe offcanvas_section p-0'>
                    {/* <img src={menu} onClick={()=>{ChangeDisplay(!display)}} className='w-25'></img> */}


                    <Offcanvas show={display} onHide={() => { ChangeDisplay(false) }} className='w-50' >
                        <Offcanvas.Header>
                            <h5 className='text-center'>MY MONEY</h5>
                        </Offcanvas.Header>
                        <Offcanvas.Body className='p-0'>
                            <div className=' w-100 h-100  px-3 shadow left_section'>
                                <Link to='#' className='nav-link choice px-2 pt-1 pb-1 font_color'>Dashboard</Link>
                                <Link to='/addtransaction' className='nav-link choice px-2 pt-1 pb-1 font_color'>Add Expenses</Link>
                                <Link to='#' onClick={() => { setModel(!display_modal) }} className='nav-link choice px-2 pt-1 pb-1 font_color font_color'>My Wallet</Link>
                                <Link to='/Budjet' className='nav-link choice px-2 pt-1 pb-1 font_color'>Budget</Link>
                ...
                <div className='middle    px-2 shadow'>
                    <div className='d-flex justify-content-between align-items-center'>
                        <img src={menu} onClick={() => { ChangeDisplay(!display) }} className=' img'></img>

                        <h4 className='text-shadow'>Dashboard</h4>
                        {/* <input placeholder='search' className='border-0 bg-dark rounded p-1 text-light'></input> */}
                        <div className='justify-content-center row profile  mx-0'>
                    ...
                    <div >
                        <h6>My Cards</h6>
                        <div className='d-flex justify-content-between scrool'>
                    ...
                    <div className='p-1'>
                        ...
                        <div className='col-12 px-2 justify-content-center graph'>
                ...
                <div className='Right-side  w-50 px-4'>
                    ...
                    <div className='shadow mb-3 transactions'>
                    ...
                    <div className='shadow catigories'>
                        ...
                        <div className='d-flex justify-content-around pb-3'>
                            ...
                            <div className=' col-3  rounded  p-1 category_box' >
                                <p><StorefrontRoundedIcon /></p>
                                <p className='pt-2 pb-0 m-0'>shopping</p>
                                <p>$</p>
                            </div>
                        </div>
                    ...
                    <div className='budjet'>
                        ...
                        <div className='d-flex justify-content-around mt-2 mb-2 pt-2'>
                            <div className=' col-3 rounded shadow px-1 small_box'>
                                <p>Total Balance</p>
                                <p className='tbudget'>${totalBudjet}</p>
                            </div>
                            ...
                            <div className=' col-3  rounded shadow px-1 small_box'>
                                <p>Savings</p>
                                <p className='balance'>${Wbalance}</p>
                            </div>
                        </div>
                    </div>
                </div>
